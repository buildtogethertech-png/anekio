...
async function main() {
  ...
  await prisma.teacherSkill.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.teacherClass.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.parent.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.class.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.student.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.subject.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.studentInterest.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.attendance.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.examSeries.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.exam.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.examEvaluator.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.examResult.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.examResultAudit.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.examPaper.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.contest.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.contestEntry.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.grant.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.schoolOnboardingState.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.schoolOnboardingImport.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.googleDriveConnection.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.onboardingGoogleSheet.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.application.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.admissionLead.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.admissionLeadEvent.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.documentTemplate.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.documentTemplateVersion.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.issuedDocument.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.documentEvent.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.notice.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.noticeRecipient.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.noticeAudience.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.noticeClass.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.leaveType.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.leaveRequest.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.substituteAssignment.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.schoolHoliday.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.schoolSession.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.staffMember.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.staffDay.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.staffAttendanceAudit.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.staffPayrollRun.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.period.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.room.updateMany({ data: { orgId: saasOrg.id } });
  await prisma.timetableSlot.updateMany({ data: { orgId: saasOrg.id } });
